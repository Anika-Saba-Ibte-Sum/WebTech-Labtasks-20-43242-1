...
<tbody>
    ...
    <tr>
        ...
        <td><a href="/New folder/Lab task 5/views/delete-product-view.php?id=<?php echo $row["SL"]; ?>">Delete</a></td>
        <td><a href="/New folder/Lab task 5/views/update-product-view.php?id=<?php echo $row["SL"]; ?>">Edit</a></td>
    </tr>
    <?php } ?>
</tbody>
</table>
